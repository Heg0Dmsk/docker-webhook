...
<ul style="margin: 0px;">
  <li><a href="#how_to_use">How to Use</a>
    <ul> 
      ...
      <li><a href="#how_to_use_docker_cli">Docker CLI</a></li>
    </ul>
  </li>
  <li><a href="#how_to_use">How to Use</a>
    <ul> 
      <li><a href="#updating_docker_compose">Docker Compose</a></li>
      <li><a href="#updating_docker_cli">Docker CLI</a></li>
    </ul>
  </li>
  <li><a href="#parameters">Parameters</a></li>
  <li><a href="#configuring_hooks">Configuring Hooks</a></li>  
</ul>
